...
### ENHANCEMENTS
* Introduce message iterator to avoid loading all messages into memory at once upon resend request https://github.com/fintake/quickfix/pull/659
* Only lock fieldmap once during message parsing https://github.com/fintake/quickfix/pull/658
* Optimize tag value parsing https://github.com/fintake/quickfix/pull/657
* Use bytes.Count to count the number of message fields https://github.com/fintake/quickfix/pull/655
* Port config documentation into proper go doc format https://github.com/fintake/quickfix/pull/649
* Support TLS configuration as raw bytes https://github.com/fintake/quickfix/pull/647

### BUG FIXES
* Use the Go generated file convention https://github.com/fintake/quickfix/pull/660
* Fix stuck call to Dial when calling Stop on the Initiator https://github.com/fintake/quickfix/pull/654
* Do not increment NextTargetMsgSeqNum for out of sequence Logout and Test Requests https://github.com/fintake/quickfix/pull/645

## 0.9.4 (May 29, 2024)

### ENHANCEMENTS
* Adds log to readLoop just like writeLoop https://github.com/fintake/quickfix/pull/642

### BUG FIXES
* Maintain repeating group field order when parsing messages  https://github.com/fintake/quickfix/pull/636

## 0.9.3 (May 9, 2024)

### BUG FIXES
* Change filestore.offsets from map[int]msgDef to sync.Map https://github.com/fintake/quickfix/pull/639
* Unregister sessions on stop https://github.com/fintake/quickfix/pull/637
* Corrects ResetOnLogon behavior for initiators https://github.com/fintake/quickfix/pull/635

### FEATURES
* Add AllowUnknownMessageFields & CheckUserDefinedFields settings as included in QuickFIX/J https://github.com/fintake/quickfix/pull/632

## 0.9.2 (April 23, 2024)

### BUG FIXES
* Prevent message queue blocking in the case of network connection trouble https://github.com/fintake/quickfix/pull/615 https://github.com/fintake/quickfix/pull/628
* Corrects validation of multiple repeating groups with different fields https://github.com/fintake/quickfix/pull/623

## 0.9.1 (April 15, 2024)

### BUG FIXES
* Preserve original body when resending https://github.com/fintake/quickfix/pull/624

## 0.9.0 (November 13, 2023)

### FEATURES
* Add Weekdays config setting as included in QuickFIX/J https://github.com/fintake/quickfix/pull/590
* `MessageStore` Refactor

The message store types external to a quickfix-go application have been refactored into individual sub-packages within `quickfix`. The benefit of this is that the dependencies for these specific store types are no longer included in the quickfix package itself, so many projects depending on the quickfix package will no longer be bloated with large indirect dependencies if they are not specifically implemented in your application. This applies to the `mongo` (MongoDB), `file` (A file on-disk), and `sql` (Any db accessed with a go sql driver interface). The `memorystore` (in-memory message store) syntax remains unchanged. The minor drawback to this is that with some re-packaging came some minor syntax changes. See https://github.com/fintake/quickfix/issues/547 and https://github.com/fintake/quickfix/pull/592 for more information. The relevant examples are below.
...
import (
  ...
  "github.com/fintake/quickfix/store/mongo"
)
...
import (
  "github.com/fintake/quickfix"
  "github.com/fintake/quickfix/store/file"
)
...
import (
  "github.com/fintake/quickfix"
  "github.com/fintake/quickfix/store/sql"
)
...
### ENHANCEMENTS
* Acceptance suite store type expansions https://github.com/fintake/quickfix/pull/596 and https://github.com/fintake/quickfix/pull/591
* Support Go v1.21 https://github.com/fintake/quickfix/pull/589


### BUG FIXES
* Resolves outstanding issues with postgres db creation syntax and `pgx` driver https://github.com/fintake/quickfix/pull/598
* Fix sequence number bug when storage fails https://github.com/fintake/quickfix/pull/432
